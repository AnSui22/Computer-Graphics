...
const char* ourObjectPath = "./Textured_mesh_1.obj";
// translate it so it's at the center of the scene
// it's a bit too big for our scene, so scale it down
glm::mat4 objectXform = glm::scale(glm::translate(glm::mat4(1.0f), glm::vec3(0.5f, 0.1f, 0.0f)), glm::vec3(0.03f, 0.03f, 0.03f));
...
void proInput(GLFWwindow* window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_L) == GLFW_PRESS && !angularKeyPressed)
	{
		angular = !angular;
